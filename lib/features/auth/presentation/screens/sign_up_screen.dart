...
GlobalKey<FormState> _setPasswordFormKey = GlobalKey<FormState>();
GlobalKey<FormState> _profileInfoFormKey = GlobalKey<FormState>();
    ...
    onButtonPressed: (){
      if (_profileInfoFormKey.currentState!.validate()) {
        UserModel user = UserModel(
          userId: '', // This will be generated by Firebase
        ...
        context.read<SignUpBloc>().add(SignUpRequired(user: user, password: _passwordController.text));
      }
    },
    color: Colors.grey,
    buttonText: "Continue",
...
Container(
  ...
  child: DropdownButtonHideUnderline(
    child: DropdownButtonFormField<String>(
      ...
      style: TextStyle(
    color: Color(0xFFFAFFFF), // This is the color used when an item is selected
    ...
    return DropdownMenuItem<String>(
      ...
      onChanged: (String? newValue) {
        ...
        const SizedBox(height: 12.0,),
      MyTextField(controller: _dobController,
        ...
        const SizedBox(height: 12.0,),
      MyTextField(controller: _addressController,
...
Pages buildSetPassword() {
  ...
  return Pages(
    ...
    // Add the SignUpRequired event to the SignUpBloc
    context.read<SignUpBloc>().add(SignUpRequired(user: user, password: _passwordController.text));
    ...
    children: [
      ...
      MyTextField(controller: _passwordController,
        hintText: "Enter password*", obscureText: true, keyboardType: TextInputType.text ,
        validator: (value) {
          if (value == null || value.isEmpty) {
      ...
      const SizedBox(height: 12.0,),
      MyTextField(controller: _confirmPasswordController,
        hintText: "Confirm password*", obscureText: true, keyboardType: TextInputType.text ,
        validator: (value) {
...
if (_signUpFormKey.currentState!.validate()) {
  ...
  children: [
    ...
    const Align(
      alignment: Alignment.centerLeft,
      child: Text("Phone and Email",style: TextStyle(
                                  color: Color(
                                      0xFFE9EAEC),
                                  fontFamily:
                                      'Trap', 
    ...
    const SizedBox(height: 12.0,),
    MyTextField(controller: _phoneController,
      hintText: "Enter phone*", obscureText: false, keyboardType: TextInputType.phone ,
       validator: (value) {
    if (value == null || value.isEmpty) {
    ...
    MyTextField(controller: _emailController,
      hintText: "Enter email*", obscureText: false, keyboardType: TextInputType.emailAddress ,
      validator: (value) {
    if (value == null || value.isEmpty) {
