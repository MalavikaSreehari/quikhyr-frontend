  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        preferredSize: const Size.fromHeight(329),
        child: Padding(
            ...
            title: Column(
              ...
              Row(
                children: [
                  const CircleAvatar(
                    radius: 32,
                    backgroundImage: NetworkImage(AppAssetLinks.placeholderImage),
                  ),
                  ...
                  Align(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: const Text('Edit',style: TextStyle(color: secondary,),),
                      style: OutlinedButton.styleFrom(side: const BorderSide(color: secondary)),
                    ),
                  ),
                ],
              ),
